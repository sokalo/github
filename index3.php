...
<div class="career-detail">
	...
	<div class="row">
		...
		<form id ="form" action="application_action.php" method="post" enctype="multipart/form-data">
		...
		<li class="career-field"><label for="job-position">Education:</label><br/></li>
		<li class="career-field"><label for="job-position">High School</label><br/></li>
		<li class="career-field">
		<!--<div>-->
		<table>
					<tr>
						...
						<th><input type="button" value="-" onclick="myDeleteFunction()"></th>
					...
					<table id="myTable">
								  <tr>
									<td><input type="text" name="highschool[0]" style="height:45px;">&nbsp;</td>
									<td><input type="date" class="startdate" name="highschool[1]" style='height:45px;'>&nbsp;</td>
									<td><input type="date" class="enddate" name="highschool[2]" onChange="return checkdate()" style='height:45px;'>&nbsp;</td>
									<td><input type="text" name="highschool[3]" style="height:45px;">&nbsp;</td>
		...
		<!--	</div>-->
			...
			<li class="career-field"><label for="job-position">University</label></li>
			<li class="career-field">
			<div>
				<table style="padding:50px;">
					<tr>
						...
						<th>End Date</th>
						<th>Place Of School</th>
						<th><input type="button" value="+" onclick="myFunction1()"></th>
						<th><input type="button" value="-" onclick="myDeleteFunction1()"></th>
					</tr>
					...
					<tr>
						<td colspan="4">
							...
							<table id="myTable1">
								  <tr>
										<td><input type="text" name="uni[0]" style="height:45px;">&nbsp;</td>
										<td><input type="date" class="startdate" name="uni[1]" style="height:45px; mergin:10px;">&nbsp;</td>
										<td><input type="date" class="enddate" name="uni[2]" onChange="return checkdate()" style='height:45px;'>&nbsp;</td>
										<td><input type="text" name="uni[3]" style="height:45px;">&nbsp;</td>
								  </tr>
								</table>
			...
			<li class="career-field"><label for="job-position">Others</label></li>
			<li class="career-field">
			<div>
				<table>
					<tr>
						...
						<th>End Date</th>
						<th>Place Of School</th>
						<th><input type="button" value="+" onclick="myFunction2()"></th>
						<th><input type="button" value="-" onclick="myDeleteFunction2()"></th>
					</tr>
					<tr>
						<td colspan="4">
						...
						<table id="myTable2">
								  <tr>
										<td><input type="text" name="other[0]"  style="height:45px;">&nbsp;</td>
										<td><input type="date" class="startdate" name="other[1]" style='height:45px;'>&nbsp;</td>
										<td><input type="date" class="enddate" name="other[2]" onChange="return checkdate()" style='height:45px;'>&nbsp;</td>
										<td><input type="text" name="other[3]"  style="height:45px;">&nbsp;</td>
								  </tr>
								</table>
