...
if($result->num_rows > 0)
{
	...
	//	else{
	//	echo mysql_error();
		echo "jasondata". json_encode($questionarray);
		}
...
<link rel="shortlink" href="http://umgroups.com/cambodia/?p=12444">
		<script type="text/javascript">
			...
			var name = jQuery.trim($("#answer").val());

			if ((name.length == 0))
			{
			    //Your code
			    alert("The Question might not be empty"); 
			}
													...
													/*	if ($result1==null)
														...
														else if ($result1->num_rows > 0) 
														{
															...
															{						
																...
																echo '<td class="center">'.'<textarea name="answer[]" col="150" id="answer" row="5" style="width:400px;" required></textarea>'.'</td>';
