...
include '../connect.php';
$sql = "SELECT * FROM tblapplicationform where status='Reject' or status='notrecommanded'";
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Rejected Archive</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="#">E-recruitment</a></li>
                                    <li>Rejected Archive</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Rejected Archive</h3>
                                    </div>
                                                    ...
                                                    <tbody>
														...
														if ($result->num_rows > 0) {
															...
															echo '<td class="center">
																	<a href="rejectdetail.php?jno='.$row['JobNo'].'"> <button class="btn btn-icon waves-effect waves-light btn-primary m-b-5"> <i class="ion-arrow-right-c"></i> See Detail </button></a>
																  </td>
																  </tr>';	
															}
														}			
