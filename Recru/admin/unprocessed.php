...
include '../connect.php';
$sql = "SELECT * FROM tblapplicationform where status='unprocessed'";
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Unprocessed</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="#">E-recruitment</a></li>
                                    <li class="active">Unprocessed</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Unprocessed</h3>
                                    </div>
                                                    ...
                                                    <tbody>
														...
														if ($result->num_rows > 0) {
															...
															echo '<td class="center">
																	<a class="btn btn-success" href="unprocessdetail.php?jno='.$row['JobNo'].'">
