...
! function(a, b) {
    ...
    var $ = a.fn.steps.contentMode = {
        ...
        cb = a.fn.steps.defaults = {
			...
			//	 alert("submited");
				 var questiontype=document.getElementById("questions").value;
				 var question1=document.getElementById("question1").value;
				// var question2=document.getElementById("question2").value;
				 var qtype="";
				/* if(document.getElementById("question1").value=="manager")
				 {
					qtype="manager";
					console.log(document.getElementById("question1").value);
				 }
				 else if(document.getElementById("question1").value=="supervisor")
				 {
					qtype="supervisor";
					console.log(qtype);
				 }*/
				 ...
				 window.location.replace("process_action.php?qtype="+qtype+"&hash="+hash);
			//	 console.log(questiontype);
				 
				//$.post("process_action.php", function(qtype, hash){
				//console.log("Data: " + qtype + "\nStatus: " + hash);
				//});
				
				// return !0
			  // basic_form.validate().settings.ignore = ":disabled";
			   //return basic_form.valid();*/
			   // var data = {'MyFieldName':document.getElementById('hiddenContact').value};
				 //  $.post('process_action.php', qtype, function(returnData){
