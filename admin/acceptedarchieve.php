...
include '../connect.php';
$sql = "SELECT * FROM tblapplicationform where status='Accepted' or status='recommend'";
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <!-- Page-Title -->
                          <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Accepted Archieve</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="#">E-recruitment</a></li>
                                    <li class="active">Accepted Archieve</li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Accepted Archieve</h3>
                                    </div>
                                                    ...
                                                    <tbody>
														...
														if ($result->num_rows > 0) {
															...
															echo '<td class="center">
																	<a class="btn btn-success" href="accepteddetail.php?jno='.$row['JobNo'].'">
																		<i class="halflings-icon white zoom-in"></i> See Details 
																	</a>
																	</td>
																	</tr>';	
													}
