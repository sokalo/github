...
include '../connect.php';
$sql = "SELECT * FROM tblapplicationform where status!='unprocessed' AND status!='Reject' AND status!='recommend'";
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">On Process</h4>
                                                    ...
                                                    <tbody>
														...
														if ($result->num_rows > 0) {
															...
															echo '<td class="center">
																	<a href="processdetail.php?jno='.$row['JobNo'].'"> <button class="btn btn-icon waves-effect waves-light btn-primary m-b-5"> <i class="ion-arrow-right-c"></i> See Details </button></a>
																	</td>
																	</tr>';	
															}
														}			
